...
namespace APLPX.Client.Mock.Mappers
{
    ...
    public static class PriceRulesMapper
    {
        ...
        public static List<DTO.PricingLinkedPriceListRule> ToDtos(this List<Display.PricingLinkedPriceListRule> displayList)
        {
            var dtoList = new List<DTO.PricingLinkedPriceListRule>();

            foreach (Display.PricingLinkedPriceListRule dto in displayList)
            {
