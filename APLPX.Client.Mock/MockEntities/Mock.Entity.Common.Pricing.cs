...
namespace APLPX.Client.Mock.Entity
{
    ...
    public class PricingResultEdit
    {
        ...
        public PricingResultEdit(
            string name,
            string title,
            ENT.PricingResultsEditType type
            ) {
            Name = name;
            Title = title;
            Type = type;
        ...
        public string Title { get;  set; }
        [DataMember]
        public ENT.PricingResultsEditType Type { get;  set; }
    }
    ...
    public class PricingResultWarning
    {
        ...
        public PricingResultWarning(
            string name,
            string title,
            ENT.PricingResultsWarningType type
            ) {
            Name = name;
            Title = title;
            Type = type;
        ...
        public string Title { get;  set; }
        [DataMember]
        public ENT.PricingResultsWarningType Type { get;  set; }
    }
