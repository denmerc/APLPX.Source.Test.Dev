...
namespace APLPX.Client.Mock.Entity
{
    ...
    public class PricingEverydayResultPriceList : PricingEverydayPriceList
    {
        ...
        public PricingEverydayResultPriceList(
            ...
            decimal priceChange,
            ENT.PricingResultEdit priceEdit,
            ENT.PricingResultWarning priceWarning
        ...
        [DataMember]
        [BsonIgnore]
        public ENT.PricingResultEdit PriceEdit { get;  set; }
        [BsonIgnore]
        [DataMember]
        public ENT.PricingResultWarning PriceWarning { get;  set; }
    }
}
