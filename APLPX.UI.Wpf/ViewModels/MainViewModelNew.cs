    ...
    public class MainViewModelNew : ViewModelBase
    {
        ...
        private void InitializeCommands()
        {
            ...
            SaveAnalyticIdentityCommand = ReactiveCommand.CreateAsyncTask(async _ =>
                await Task.Run(() =>
                {
                    var session = new DTO.Session<DTO.Analytic>() { Data = SelectedAnalytic.ToDto() };
        ...
        /// <summary>
        /// Command for loading analytic on Edit Action
        /// </summary>
        ...
        /// <summary>
        /// Commad that is invoked when any action is selected in the bound view.
        /// </summary>
        ...
        {
            //TODO: display error in a standardize way. This is for testing only.
