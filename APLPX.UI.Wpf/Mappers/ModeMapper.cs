...
namespace APLPX.UI.WPF.Mappers
{
    ...
    {
        public static Display.AnalyticValueDriverMode ToDisplayEntity(this DTO.AnalyticDriverMode dto)
        {
        ...
        public static DTO.AnalyticDriverMode ToDto(this Display.AnalyticValueDriverMode displayEntity)
        {
            ...
            if (displayEntity.IsAutoGenerated)
            {
                ...
                Display.ValueDriverGroup group = null;
                ...
                {
                    group = new Display.ValueDriverGroup();
                }
