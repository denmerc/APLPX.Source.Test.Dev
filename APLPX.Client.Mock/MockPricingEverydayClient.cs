...
namespace APLPX.Client.Mock.Proxies
{
    public class MockPricingEverydayClient : IPricingEverydayService
    {
        ...
        public Session<PricingEveryday> LoadPricingEveryday(Session<PricingEveryday> session)
        {
            ...
            {
                Data = new PricingEveryday(newPE.Id, 
                                           newPE.SearchGroupKey,
                                           newPE.Identity.ToDto(),
                                           newPE.FilterGroups.ToDtos(),
                                           newPE.ValueDrivers.ToDtos(),
                                           newPE.KeyValueDriver.ToDto(),
                                           newPE.LinkedValueDrivers.ToDtos(),
                                           newPE.PricingModes.ToDtos(),
                                           newPE.PriceListGroups.ToDtos(),
                                           newPE.KeyPriceListRule.ToDto(),
                                           newPE.LinkedPriceListRules.ToDtos(),
                                           newPE.Results.ToDtos())
        ...
        public Session<List<PricingEveryday>> LoadList(Session<NullT> session)
        {
            ...
            //                     }
            //    ).ToList();
            return new Session<List<PricingEveryday>> { 
        ...
        public Session<PricingEveryday> LoadFilters(Session<PricingEveryday> session)
        {
            ...
            return new Session<PricingEveryday>
            {
                Data = new PricingEveryday(p.Id, filterGroups.ToDtos() )
                //Data = new PricingEveryday
                //{
                //    Id = p.Id,
        ...
        public Session<PricingEveryday> LoadResults(Session<PricingEveryday> session)
        {
            ...
            return new Session<PricingEveryday>
            {
                Data = new PricingEveryday(session.Data.Id,
                          null,
                          null,
                          null,
                          null,
