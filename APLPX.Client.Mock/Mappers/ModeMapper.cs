...
namespace APLPX.Client.Mock.Mappers
{
    ...
    public static class ModeMapper
    {
        ...
        public static List<DTO.PricingMode> ToDtos(this List<Display.PricingMode> displayList)
        {
            var dtoList = new List<DTO.PricingMode>();

            foreach (Display.PricingMode dto in displayList)
            {
