...
namespace APLPX.Client.Mock.Mappers
{
    ...
    public static class PriceListMapper
    {
        ...
        public static List<DTO.AnalyticPriceListGroup> ToDtos( this List<Display.AnalyticPriceListGroup> displayList)
        {
            var items = new List<DTO.AnalyticPriceListGroup>();

            foreach (Display.AnalyticPriceListGroup item in displayList)
            {
        ...
        public static List<DTO.PricingEverydayPriceListGroup> ToDtos(this List<Display.PricingEverydayPriceListGroup> displayList)
        {
            var dtoList = new List<DTO.PricingEverydayPriceListGroup>();

            foreach (Display.PricingEverydayPriceListGroup dto in displayList)
            {
        ...
        public static DTO.PricingEverydayResultPriceList ToDto(this Display.PricingEverydayResultPriceList displayEntity)
        {
            ...
            var dto = new DTO.PricingEverydayResultPriceList(displayEntity.ResultId,
                                        ...
                                        displayEntity.PriceEdit != null ? displayEntity.PriceEdit.ToDto() : new DTO.PricingResultEdit(),
                                        displayEntity.PriceWarning != null ? displayEntity.PriceWarning.ToDto() : new DTO.PricingResultWarning());
            return dto;
        }
