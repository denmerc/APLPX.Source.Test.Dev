...
namespace APLPX.Client.Mock
{
    public class MockAnalyticClient : IAnalyticService
    {
        ...
        public APLPX.Entity.Session<APLPX.Entity.Analytic> Load(APLPX.Entity.Session<APLPX.Entity.Analytic> session)
        {
            var a = session.Data as ENT.Analytic;
            var newA = AnalyticAll_NoFilters.AsQueryable()
                .Where(x => x.Id == a.Id).SingleOrDefault();
        ...
        public APLPX.Entity.Session<APLPX.Entity.Analytic> LoadIdentity(APLPX.Entity.Session<APLPX.Entity.Analytic> session)
        {
            throw new NotImplementedException();
        }

        public APLPX.Entity.Session<APLPX.Entity.Analytic> RunDrivers(APLPX.Entity.Session<APLPX.Entity.Analytic> session)
        {
            throw new NotImplementedException();
        }
