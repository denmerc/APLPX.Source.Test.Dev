...
namespace APLPX.Server.Entity
{
    ...
    public class PricingEveryday
    {
        ...
        public PricingEveryday(
            ...
            List<PricingEverydayLinkedValueDriverGroup> linkedValueDrivers
            ) {
            Id = id;
        ...
        [DataMember]
        public List<PricingEverydayLinkedValueDriverGroup> LinkedValueDrivers; //CLIENT { get; set; }
        [DataMember]
